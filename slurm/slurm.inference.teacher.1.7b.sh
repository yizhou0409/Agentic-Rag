...
python rar_inference.py --config-name inference_int4.yaml inference.max_turns=5 model.reasoner_name_or_path=/scratch/yl9038/longcot-rag-inference/trained_teacher_models/qwen3-1.7b
