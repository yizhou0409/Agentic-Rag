...
class DataArguments:
    ...
    prompt_template_path: Optional[str] = None  # Path to YAML file with prompt template
    prompt_template: Optional[str] = None  # The loaded template string
    ...
    def load_prompt_template(self):
        if self.prompt_template_path:
            ...
            # Use 'user_prompt' key by default
            self.prompt_template = yaml_data.get('user_prompt')
            if not self.prompt_template:
                raise KeyError(f"No 'user_prompt' key found in {self.prompt_template_path}")
